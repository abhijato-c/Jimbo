...
inline void WKmoves(chess &b, vector<int> &Moves){
    bitboard iter = b.wk;
    int i = -1;
    while(iter!=0){
        i += ctz(iter) + 1;
        ...
        if ((((1ULL << i) & clear_h) << 7) &~ b.wpcs)
            Moves.push_back((((1ULL << i) << 7) & b.bpcs) << 12 | ctz((1ULL << i) << 7) << 6 | i);
        if (((1ULL << i) << 8) &~ b.wpcs)
            Moves.push_back((((1ULL << i) << 8) & b.bpcs) << 12 | ctz((1ULL << i) << 8) << 6 | i);
        if ((((1ULL << i) & clear_a) << 9) &~ b.wpcs)
            Moves.push_back((((1ULL << i) << 9) & b.bpcs) << 12 | ctz((1ULL << i) << 9) << 6 | i);
        if ((((1ULL << i) & clear_a) << 1) &~ b.wpcs)
            Moves.push_back((((1ULL << i) << 1) & b.bpcs) << 12 | ctz((1ULL << i) << 1) << 6 | i);
...
inline void BKmoves(chess &b, vector<int> &Moves){
    int i = ctz(b.bk);

    if ((((1ULL << i) & clear_h) << 7) &~ b.bpcs)
        Moves.push_back((((1ULL << i) << 7) & b.wpcs) << 12 | ctz((1ULL << i) << 7) << 6 | i);
    if (((1ULL << i) << 8) &~ b.bpcs)
        Moves.push_back((((1ULL << i) << 8) & b.wpcs) << 12 | ctz((1ULL << i) << 8) << 6 | i);
    if ((((1ULL << i) & clear_a) << 9) &~ b.bpcs)
        Moves.push_back((((1ULL << i) << 9) & b.wpcs) << 12 | ctz((1ULL << i) << 9) << 6 | i);
    if ((((1ULL << i) & clear_a) << 1) &~ b.bpcs)
        Moves.push_back((((1ULL << i) << 1) & b.wpcs) << 12 | ctz((1ULL << i) << 1) << 6 | i);
...
inline void WNmoves(chess &b, vector<int> &Moves){
    bitboard iter = b.wn;
    int i = -1;
    while(iter!=0){
        i += ctz(iter) + 1;
        ...
        if ((((1ULL << i) & clear_a & clear_b) >> 6) &~ b.wpcs)
            Moves.push_back((((1ULL << i) >> 6) & b.bpcs) << 12 | ctz((1ULL << i) >> 7) << 6 | i);
        if ((((1ULL << i) & clear_a) >> 15) &~ b.wpcs)
            Moves.push_back((((1ULL << i) >> 15) & b.bpcs) << 12 | ctz((1ULL << i) >> 15) << 6 | i);
        if ((((1ULL << i) & clear_h) >> 17) &~ b.wpcs)
            Moves.push_back((((1ULL << i) >> 17) & b.bpcs) << 12 | ctz((1ULL << i) >> 17) << 6 | i);
        if ((((1ULL << i) & clear_h & clear_g) >> 10) &~ b.wpcs)
            Moves.push_back((((1ULL << i) >> 10) & b.bpcs) << 12 | ctz((1ULL << i) >> 10) << 6 | i);
        if ((((1ULL << i) & clear_h & clear_g) << 6) &~ b.wpcs)
            Moves.push_back((((1ULL << i) << 6) & b.bpcs) << 12 | ctz((1ULL << i) << 6) << 6 | i);
...
inline void BNmoves(chess &b, vector<int> &Moves){
    bitboard iter = b.bn;
    int i = -1;
    while(iter!=0){
        i += ctz(iter) + 1;
        ...
        if ((((1ULL << i) & clear_a & clear_b) >> 6) &~ b.bpcs)
            Moves.push_back((((1ULL << i) >> 6) & b.wpcs) << 12 | ctz((1ULL << i) >> 7) << 6 | i);
        if ((((1ULL << i) & clear_a) >> 15) &~ b.bpcs)
            Moves.push_back((((1ULL << i) >> 15) & b.wpcs) << 12 | ctz((1ULL << i) >> 15) << 6 | i);
        if ((((1ULL << i) & clear_h) >> 17) &~ b.bpcs)
            Moves.push_back((((1ULL << i) >> 17) & b.wpcs) << 12 | ctz((1ULL << i) >> 17) << 6 | i);
        if ((((1ULL << i) & clear_h & clear_g) >> 10) &~ b.bpcs)
            Moves.push_back((((1ULL << i) >> 10) & b.wpcs) << 12 | ctz((1ULL << i) >> 10) << 6 | i);
        if ((((1ULL << i) & clear_h & clear_g) << 6) &~ b.bpcs)
            Moves.push_back((((1ULL << i) << 6) & b.wpcs) << 12 | ctz((1ULL << i) << 6) << 6 | i);
...
inline void WPmoves(chess &b, vector<int> &Moves){
    bitboard iter = b.wp;
    int i = -1;
    while(iter!=0){
        i += ctz(iter) + 1;
...
inline bitboard BQmoves(const int &qpos, chess &b){
    return (bishop_moves_lkup[qpos][_pext_u64(b.pieces,bishop_blockers[qpos])] |
